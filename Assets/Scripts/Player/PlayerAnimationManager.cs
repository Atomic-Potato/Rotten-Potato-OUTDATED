...
public class PlayerAnimationManager : MonoBehaviour
{
    ...
    {
        return 
            PlayerMove.IS_GROUNDED && 
            PlayerMove.IsMovementActive &&
    ...
    bool IsJumping()
    {
        return 
            !PlayerMove.IS_GROUNDED &&
            Player.Instance.Rigidbody.velocity.y > 0f;
    }
